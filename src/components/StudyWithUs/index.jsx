    ...
    <div>
      ...
      <div className="page-content">
        ...
        <p className="page-content-text">
          ...
          a remarkable position, being ranked in the top 3% of global
        ...
        <p className="page-content-text">
          ...
          subjects, demonstrating their excellence and expertise in a diverse
          range of academic fields. Furthermore, out of a possible 46 subjects,
          these universities feature in the top 100 in an impressive 39
        ...
        <p className="page-content-text">
          ...
          world, owing to the comprehensive and rigorous education they receive.
          These outcomes are reflected in the high completion and employment
          rates, as well as the low rates of under-employment among graduates.
          The universities' focus on equipping students with the skills and
          knowledge necessary to excel in their chosen fields ensures that they
        ...
        <p className="page-content-text">
          ...
          institution. With its unique emphasis on land-based disciplines such
          as agriculture, environmental science, and landscape architecture,
        ...
        <p className="page-content-text">
          ...
          but also in various subject areas, attest to their commitment to
          providing world-class education and research opportunities. Graduates
          from these universities benefit from exceptional career prospects,
          ensuring a strong foundation for their professional endeavors. The
          diversity of subjects and areas of specialization offered by these
          institutions further contributes to the richness and breadth of New
          Zealand's higher education landscape, making it an attractive
          destination for students seeking excellence and a truly global
          education.
        </p>
      </div>
